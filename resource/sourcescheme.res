...
Scheme
{
	...
	BaseSettings
	{
		...
		Frame.BgColor					"ControlBG"	[$WIN32]
		Frame.BgColor					"ControlBG"		[$X360]
		Frame.OutOfFocusBgColor			"ControlBG"	[$WIN32]
		Frame.OutOfFocusBgColor			"ControlBG"		[$X360]
		Frame.FocusTransitionEffectTime	"0.3"							// time it takes for a window to fade in/out on focus/out of focus
		Frame.TransitionEffectTime		"0.3"				[$WIN32]	// time it takes for a window to fade in/out on open/close
		Frame.TransitionEffectTime		"0.3"				[$X360]		// time it takes for a window to fade in/out on open/close
